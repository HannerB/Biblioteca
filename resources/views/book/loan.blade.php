                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('books.submit_loan', $book->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="quantity" name="quantity" class="form-input mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="duration" class="block font-medium text-sm text-gray-700">Duración del Préstamo (días)</label>
                            <input type="number" id="duration" name="duration" class="form-input mt-1 block w-full" required>
                        </div>
